...
INSTALL_ARGS=$(cat ubuntu-20.04/install-partial/install_args.sh)

# create installer
rm -rf ubuntu-20.04/install.sh
echo "$INSTALL_ARGS" >> ubuntu-20.04/install.sh
...
echo "$INSTALL_ARGS" >> ubuntu-22.04/install.sh
...
echo "$INSTALL_ARGS" >> almalinux-9.4/install.sh
