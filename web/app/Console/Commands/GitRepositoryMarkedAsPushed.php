...
class GitRepositoryMarkedAsPushed extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'omega:git-repository-mark-as-pushed {id}';
    ...
    public function handle()
    {
        ...
        $repository->status = GitRepository::STATUS_PUSHED;
        if($repository->save()) {
