...
class HtaccessBuildHotlinkProtection implements ShouldQueue
{
    ...
    public $model;
    public $startComment = '# Section managed by omegaPanel: Hotlink Protection, do not edit';
    public $endComment = '# End section managed by omegaPanel: Hotlink Protection';
