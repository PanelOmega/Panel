...
class FtpServerInstaller
{
    ...
    public function run()
    {
        ...
        $shellFileContent .= 'systemctl is-active --quiet vsftpd ';
        $shellFileContent .= '&& echo "FTP Server is installed and configured successfully!" ';
        $shellFileContent .= '|| echo "FTP Server failed to start"' . PHP_EOL;
