...
<html>
<head>
    <title>Panel Omega - Passenger Node.js App </title>
...
<main class="flex min-h-screen flex-col items-center justify-between p-24">
    <div class="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex"><p
            ...
            Get started by editing&nbsp;<code class="font-mono font-bold">public_html/app.js</code></p>
        <div
            ...
            <a class="pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0"
               href=""
               target="_blank" rel="noopener noreferrer">By Cloud Vision Ltd.</a></div>
    </div>
    <div
    ...
    <div class="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left"><a
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Find in-depth information about Panel Omega features and API.</p>
        </a><a
            href=""
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Learn about Panel Omega in an interactive course with&nbsp;quizzes!</p>
        </a><a
            href=""
            class="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50">Explore starter templates for Omega.</p></a><a
            href=""
            class="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
            ...
            <p class="m-0 max-w-[30ch] text-sm opacity-50 text-balance">
                Instantly deploy your Node.js site to a shareable URL with Omega.
            </p>
        </a>
    </div>
</main>
